...
export const Button = Object.assign(
  forwardRef<HTMLButtonElement, ButtonProps>(({ className, variant, size, asChild = false, ...props }, ref) => {
...
export const CircleButton = Object.assign(
  forwardRef<HTMLButtonElement, ButtonProps>(({ className, variant, children, ...props }, ref) => (
    <button
      className={cn(
...
export const LinkButton = Object.assign(
  forwardRef<ElementRef<typeof Link>, ComponentPropsWithoutRef<typeof Link>>(({ className, href, ...props }, ref) => (
