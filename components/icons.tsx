...
export const GenshinCloseIcon: IconComponent = (props: IconProps) => (
...
export const DropdownIcon: IconComponent = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
    <path d="M20 8H4L12 16L20 8Z" fill="currentColor" />
  </svg>
);

export const FilterIcon: IconComponent = ({ className, ...props }) => (
...
export const ReverseIcon: IconComponent = ({ className, ...props }) => (
...
export const AscensionStarIcon: IconComponent = (props) => (
...
export const formatAscension = (label: string, className?: string) => (
  <>
    {label}
    <AscensionStarIcon className={cn('ml-1 size-5', className)} />
  </>
);
