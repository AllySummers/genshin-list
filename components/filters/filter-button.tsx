  ...
  return (
    <button
      ...
      className={cn(
        ...
        isSelected && 'border-sheet-btn-border-selected bg-genshin-brown text-genshin-blue ring-2 ring-genshin-brown'
      )}
    >
      ...
      <div className="relative hidden aspect-square size-7 md:block">
        <Check className={cn('absolute inset-0 size-full text-icon-green', !isSelected && 'hidden')} strokeWidth="3" />
        <div
          className={cn(
