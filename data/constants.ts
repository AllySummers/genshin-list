...
export const ELEMENTS = ['Pyro', 'Hydro', 'Dendro', 'Electro', 'Anemo', 'Cryo', 'Geo'] as const;

export const WEAPONS = ['Bow', 'Catalyst', 'Claymore', 'Polearm', 'Sword'] as const;
...
export const getInitialFilterAttributes = () =>
  ({
